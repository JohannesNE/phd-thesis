...
**Paper 3** presents a clinical study of the effects of VT and RR on PPV. The results indicate that using a GAM derribed PPV may enable fluid responsiveness prediction despite low HR/RR, and that it may be valuable to correct PPV for the applied VT.
