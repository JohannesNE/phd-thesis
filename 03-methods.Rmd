...
(ref:method-reg-to-the-mean) An illustration of *regression towards the mean*. An outlying SV measurement is likely followed by a measurement closer to the "true" (mean) SV.
